...
// the fields set once and then left alone. Orientation, the two visibility
// toggles and the rank window stay on the toolbar, where they are one click
// rather than a modal round trip -- and the rank window in particular is the
// question the chart raises about itself the moment it truncates, so burying
// it two clicks deep answered it in the wrong place.
//
